...
public  class DetailsOfDocter {
    ...
    public static class UserEntity {
        ...
        public TimeingEntity getTimeing() {
            return Timeing;
        }

        public void setTimeing(TimeingEntity Timeing) {
        ...
        public BasicDetailsEntity getBasicDetails() {
            return BasicDetails;
        }

        public void setBasicDetails(BasicDetailsEntity BasicDetails) {
            this.BasicDetails = BasicDetails;
        }
    }

    public static class TimeingEntity {
        @Expose
        @SerializedName("Slot")
        private String Slot;
        @Expose
    ...
    public static class ProfesionEntity {
        @Expose
        @SerializedName("UserId")
        private int UserId;
        @Expose
    ...
    public static class BasicDetailsEntity {
        @Expose
